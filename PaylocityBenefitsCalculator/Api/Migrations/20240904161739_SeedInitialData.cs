    ...
    public partial class SeedInitialData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1998, 3, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "Spouse", "Morant", 1 },
                    { 2, new DateTime(2020, 6, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "Child1", "Morant", 3 },
                    { 3, new DateTime(2021, 5, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "Child2", "Morant", 3 },
                    { 4, new DateTime(1974, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, "DP", "Jordan", 2 }
                });
